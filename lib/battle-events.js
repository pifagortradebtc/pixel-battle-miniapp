...
export const ROUND_BATTLE_EVENT_TIMELINES = /** @type {RoundTimelineEventDef[][]} */ ([
  // ——— Round 0 (mass): 5h battle ——— (смещения ×5/8 от прежней схемы 8h)
  [
    {
      eventId: "r0_gold_zone",
      eventType: "gold_zone",
      startOffsetMs: Math.round(90 * MIN * (5 / 8)),
      durationMs: Math.round(30 * MIN * (5 / 8)),
    ...
    },
    {
      eventId: "r0_seismic",
      eventType: "seismic",
      startOffsetMs: Math.round(3 * H * (5 / 8)),
      durationMs: 0,
      warnLeadMs: 4500,
    ...
    },
    {
      ...
      startOffsetMs: Math.round((4 * H + 30 * MIN) * (5 / 8)),
      durationMs: Math.round(30 * MIN * (5 / 8)),
    ...
    },
    {
      ...
      startOffsetMs: Math.round(6 * H * (5 / 8)),
      durationMs: null,
    ...
    },
    {
      ...
      startOffsetMs: Math.round((7 * H + 30 * MIN) * (5 / 8)),
      durationMs: null,
