 ...
 * `personalRecoveryUntil` / `teamRecoveryUntil` задаются на сервере через Date.now() — сравнение только с wall-clock `now`.
 ...
 * @param {number} [now] wall epoch ms (обычно Date.now())
 */
