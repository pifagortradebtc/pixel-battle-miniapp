...
/**
 * Цены уровней — в USDT (внутренний учёт).
 * Один шаг апгрейда = 20 USDT = 140 Тугров при курсе 7:1.
 */
export const COOLDOWN_LEVELS = [
  { level: 0, sec: 30, price: 0 },
  { level: 1, sec: 28, price: 20 },
  { level: 2, sec: 25, price: 20 },
  { level: 3, sec: 22, price: 20 },
  { level: 4, sec: 18, price: 20 },
  { level: 5, sec: 15, price: 20 },
  { level: 6, sec: 12, price: 20 },
  { level: 7, sec: 10, price: 20 },
  { level: 8, sec: 8, price: 20 },
  { level: 9, sec: 6, price: 20 },
  { level: 10, sec: 5, price: 20 },
];

export const MAX_COOLDOWN_LEVEL = 10;
export const MIN_COOLDOWN_SEC = 5;

/** Базовые цены в USDT; в UI: ×7 = Тугры (1 USDT = 7 Тугров). */
export const PRICES = {
  speedBoost: 10,
  shieldPixel: 3,
  lineCapture: 20,
